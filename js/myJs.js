...
function firstQuestion(){
    ...
    Swal.fire({
        title: 'Chào cậu!',
        text: 'Tớ có điều này muốn hỏi cậu nhớ phải trả lời thật lòng nha nha nha',
...
function textGenerate() {
    var n = "";
    var text = " Tại vì cậu đẹp trai vl, tớ cảm nắng cậu mất rồi ";
    ...
    Swal.fire({
        ...
        if (result.value) {
            Swal.fire({
                ...
                background: '#fff url("img/iput-bg.jpg")',
                title: 'Tớ biết mà ^^ Yêu cậu 3000 lần',
